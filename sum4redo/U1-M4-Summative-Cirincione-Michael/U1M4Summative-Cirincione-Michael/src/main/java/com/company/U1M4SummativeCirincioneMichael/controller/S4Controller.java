...
public class S4Controller {
    ...
    public AnswerObject answer(@RequestBody AnswerObject question) {
        AnswerObject answer1 = new AnswerObject();
        AnswerObject answer2 = new AnswerObject();
        AnswerObject answer3 = new AnswerObject();
        AnswerObject answer4 = new AnswerObject();
        AnswerObject answer5 = new AnswerObject();
        AnswerObject answer6 = new AnswerObject();


        List<AnswerObject> answersEightBall = new ArrayList<>();
        answer1.setAnswer("Yes");
        answer2.setAnswer("No");
        answer3.setAnswer("Maybe");
        answer4.setAnswer("It is certain");
        answer5.setAnswer("Try again");
        answer6.setAnswer("Ask again later");
        ...
        AnswerObject answer = answersEightBall.get(randomEightBall.nextInt(6));
